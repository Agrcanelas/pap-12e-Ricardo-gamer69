...
<div class="w3-card w3-white w3-padding form-box">
    ...
    <form>
        <p>
            ...
            <input class="w3-input w3-border" type="text" placeholder="Nome Apelido" required>
        </p>
    ...
    <p class="w3-center">
        Já tens conta?
        <a href="login.php" class="w3-text-orange">Inicia sessão</a>
    </p>
</div>
